/**
 * @file two_wheel_robot.hpp
 * @brief Declaration of abstract class TwoWheelRobot.
 *
 * Description: Declares the variables and methods of class TwoWheelRobot.
 * 
 * Inheritance:
 * DifferentialDriveRobot class in order to create two wheel robot object
...
public:
     ...
     */
    TwoWheelRobot(std::size_t id,std::string name, sf::Vector2f positions, 
